...
void mef_analisys(int number_el, double h_max, double epsilon){
    
    // Defining the domain
    double a = 0.0;
    double b = 1.0;

    int nel_min = ceil(abs(b - a)/h_max);  // number of elements
    int nel = (number_el < nel_min) ? nel_min : number_el;
...
int main(){
    ...
    for (int i = 2; i < size; ++i) {
        ...
        mef_analisys(numb_el, h_max, epsilon);
    }    
